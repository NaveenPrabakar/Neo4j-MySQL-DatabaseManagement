 ...
 * 
 * The Program imports data to the tables that were created
 *
 */
...
public static void main(String args[]) throws SQLException {
    ...
    /**
     * Creates a connection between Mysql schema and java
     * 
	...
	/**
	 * The method inserts all the data into strings, then stores it in
	 * an array
	 * 
	 * @return returns all the Insert Data commands in an array
	 */
